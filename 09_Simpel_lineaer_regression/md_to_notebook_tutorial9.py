...
Til daglig arbejdsgang er **Tutorial_9_notebook.ipynb master** — ret i notebook og kør
**sync_tutorial9_md.py** for at opdatere Tutorial_9.md til MkDocs. Kør ikke dette script
efter normale ændringer i notebook; det ville overskrive jeres .ipynb med gammel .md.
"""
# Build Tutorial_9_notebook.ipynb from Tutorial_9.md (fenced python blocks -> code cells).
import json
import re
